...
registerBlockType( 'fau/portal-menu', {
	...
	description: __(
		'Display a portal menu with optional thumbnails and layout options.',
		'fau-elemental'
	),
	category: 'fau-blocks',
	icon: 'grid-view',
	...
	edit: ( props ) => {
		...
		return (
			<Fragment>
				<InspectorControls>
					<PanelBody
						title={ __( 'Portal Menu Settings', 'fau-elemental' ) }
						initialOpen={ true }
					>
						<SelectControl
						...
						<ToggleControl
							...
							checked={ thumbnails }
							onChange={ ( value ) =>
								setAttributes( { thumbnails: value } )
							}
						/>
						...
						<ToggleControl
							...
							onChange={ ( value ) =>
								setAttributes( { displaySubmenus: value } )
							}
						/>
						...
						<ToggleControl
							...
							checked={ hovertitle }
							onChange={ ( value ) =>
								setAttributes( { hovertitle: value } )
							}
						/>
				...
				<div { ...blockProps }>
					{ ! menu ? (
						<Placeholder
							...
							instructions={ __(
								'Select a menu to display as a portal menu.',
								'fau-elemental'
							) }
						>
							<SelectControl

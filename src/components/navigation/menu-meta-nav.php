...
class Menu_Meta_Nav_Modal {
    ...
    public function render() {
        ...
        <div class="menu-meta-nav">
            ...
            <!-- Search Modal -->
            <div id="search-modal" class="menu-meta-nav__modal" style="display: none;" tabindex="-1" aria-modal="true" role="dialog" aria-hidden="true">
                <div class="menu-meta-nav__modal-content">
                    <div class="menu-meta-nav__header">
                        <button class="menu-meta-nav__close-btn" aria-label="Close search">
                            <svg class="menu-meta-nav__close-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6 18L18 6M6 6L18 18" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </button>
                    </div>
                    <div class="menu-meta-nav__search-content">
                        <?php

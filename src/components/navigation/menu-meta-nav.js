(function($) {
    ...
    class MenuMetaNav {
        constructor() {
            ...
            this.searchModal.removeClass('is-open').hide();
        ...
        openModal(e) {
            ...
            switch(modalType) {
                case 'services':
                    modal = this.servicesModal;
                    break;
                case 'structure':
                    modal = this.structureModal;
                    break;
                case 'search':
                    modal = this.searchModal;
                    break;
                default:
                    return;
            }
        ...
        handleKeydown(e) {
            if (e.key === 'Escape') {
                ...
                } else if (this.searchModal.is(':visible')) {
                    this.closeModal({ currentTarget: this.searchModal.find('.menu-meta-nav__close-btn') });
                }
            }
        }
